...
1. **Crear el repositorio remoto:** Generar el proyecto vacío en GitHub (`https://github.com/alfgow/as-api.git`) y proteger la rama `main` con revisiones obligatorias.

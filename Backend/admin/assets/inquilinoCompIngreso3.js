...
function handleCompIngreso3Select(input) {
	...
	const slot = input.dataset.slot || "3";

	const preview = document.getElementById("comp-ingreso-3-preview");
	const actions = document.getElementById("comp-ingreso-3-actions");

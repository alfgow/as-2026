...
function handleCompIngreso2Select(input) {
	...
	const slot = input.dataset.slot || "2";

	const preview = document.getElementById("comp-ingreso-2-preview");
	const actions = document.getElementById("comp-ingreso-2-actions");

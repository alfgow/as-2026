  ...
  <form id="form-renovar-poliza" method="POST" action="<?= $baseUrl ?>/polizas/store"
    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <?php
          $asesorNombre = '';
          foreach ($asesores as $as) if ($as['id']==$poliza['id_asesor']) { $asesorNombre = $as['nombre_asesor']; break; }
        ?>
      ...
      <div>
        ...
        <?php
          $arrNombre = '';
          foreach ($arrendadores as $ar) if ($ar['id']==$poliza['id_arrendador']) { $arrNombre = $ar['nombre_arrendador']; break; }
        ?>
      ...
      <div>
        ...
        <?php
          $inmSel = null; foreach ($inmuebles as $inm) if ($inm['id']==$poliza['id_inmueble']) { $inmSel = $inm; break; }
        ?>
      ...
      <div>
        ...
        <input type="text" id="monto-renta-display" readonly
               ...
               value="<?= number_format((float)$poliza['monto_renta'],2) ?>">
      ...
      <div>
        ...
        <select name="inquilino_combinado" class="appearance-none w-full px-4 py-2 rounded-lg bg-[#232336] border border-indigo-800 text-indigo-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
      ...
      <div>
        ...
        <select name="obligado_combinado" class="appearance-none w-full px-4 py-2 rounded-lg bg-[#232336] border border-indigo-800 text-indigo-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
      ...
      <div>
        ...
        <select name="fiador_combinado" class="appearance-none w-full px-4 py-2 rounded-lg bg-[#232336] border border-indigo-800 text-indigo-100 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">

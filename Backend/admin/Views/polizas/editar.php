    ...
    <form id="form-editar-poliza" method="POST" action="<?= $baseUrl ?>/polizas/actualizar"
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" value="$<?= number_format((float) $poliza['monto_renta'], 2) ?>"
                       class="w-full px-3 py-2 rounded-lg bg-[#1e1e2d] text-indigo-200 border border-indigo-800 cursor-not-allowed" name="monto_renta" id="monto-renta-display" readonly>
            </div>
...
<div>
  ...
  <select name="inquilino_combinado"
          class="appearance-none w-full px-4 py-2 rounded-lg bg-[#232336] border border-indigo-800 text-indigo-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
...
<div>
  ...
  <select name="obligado_combinado"
          class="appearance-none w-full px-4 py-2 rounded-lg bg-[#232336] border border-indigo-800 text-indigo-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">

...
<?php foreach ($polizas as $poliza): ?>
    <?php
        ...
        $vigencia = htmlspecialchars($poliza['vigencia'] ?? '');
        ...
        $arrendador = htmlspecialchars($poliza['nombre_arrendador'] ?? '');
        $inquilino  = trim((string)($poliza['nombre_inquilino_completo'] ?? ''));
        $inquilino  = $inquilino !== '' ? htmlspecialchars($inquilino) : '-';
        $fiador     = htmlspecialchars($poliza['nombre_fiador'] ?? 'No aplica');
        $asesor     = htmlspecialchars($poliza['nombre_asesor'] ?? '');
        $direccion  = htmlspecialchars($poliza['direccion'] ?? '');
        $tipoInm    = htmlspecialchars($poliza['tipo_inmueble'] ?? '');
    ?>

<div class="min-h-screen bg-transparent text-white flex flex-col items-center justify-start px-3 pt-2 sm:px-4 sm:pt-8 pb-6 overflow-hidden">

  
  <!-- Chat Card -->
  <div
  class="w-full max-w-6xl mt-2 sm:mt-6 flex flex-col
  ...
  composer.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      const res = await fetch("ia/chat", {
        ...
        body: JSON.stringify({ model: "claude", prompt: text })
      });
